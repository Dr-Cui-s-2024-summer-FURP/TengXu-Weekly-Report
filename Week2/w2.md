...
- PointNet:
    ...
    - Studied related PointNet project:
        ...
        - Progress of the project:
            - Installation finished successfully.
            - Demo running:
                - Classification (ModelNet10/40): finished successfully for about **11 hours 20 minutes**.
        ...
        - Results of the project:
            - Classification (ModelNet10/40):    
                [Procedure log](/Week2/results/log_for_classification.txt) here, with best result:   
