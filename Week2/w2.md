    ...
    - Studied related PointNet project:
        ...
        - Progress of the project:
            ...
            - Demo running:
                ...
                3 running modes were set: 
                    ...
                    - ~~The Original 3rd mode, **ModelNet40, pointnet2_ssg with uniform sampling**, was **deleted** because it takes too much time.~~
                    - The 3rd mode, **ModelNet10, pointnet2_ssg without normal features**, was finished successfully for about **5 hours**.  
                    ...
                    With defult running code for these modes: 
                        ...
                        ## e.g., pointnet2_ssg with uniform sampling, this mode is deleted and will not be run
                ...
                - Part Segmentation (ShapeNet):  
                    Is running with given pretrain model and running code bellow:  

                        ## Check model in ./models 
                        ## e.g., pointnet2_msg, train cancled with pretrain data cause the traning takes too much time
        ...
        - Results of the project:
            - Classification (ModelNet10/40):    
                ...
                | ~~ModelNet40, pointnet2_ssg with uniform sampling~~ | ~~[[Procedure log for mode 3]]()~~ | `NULL` |  
                | ModelNet10, pointnet2_ssg without normal features | [[Procedure log for mode 3]](/Week2/logs/log_for_classification_3.txt) | `Best Instance Accuracy: 0.951754, Class Accuracy: 0.950536` |  

            - Part Segmentation (ShapeNet):
                [Procesure logs](/Week2/logs/) and results: 
                | Part Segmentation | Log | Reaults |
                |:---:|:---:|:---:|
                | Part Segmentation Test | [Test Log](/Week2/logs/log_for_PartSegmentation_test.txt) | Accuracy is: 0.94417,<br> Class avg accuracy is: 0.87217,<br> Class avg mIOU is: 0.82651,<br> Inctance avg mIOU is: 0.85585 |
        ...
        - Main difficlties met:
            ...
            - Some of the demo runnings take too much time to finish, eg, the Original mode 3 of classification.  
                <div style="text-align:center;">
                <img src="/Week2/pic/屏幕截图 2024-07-02 161722.png" alt="Difficult6" style="width:55%;">
                </div>
        - Solutions of these difficulties:
            ...
            - Deleted the unnecessary process of the demo running to reduce workload. 
